<?php
class Zo_Mercury_Recent_Posts_Widget_With_Thumbnails extends WP_Widget {
	...
	function __construct() {
        ...
        parent::__construct(
            ...
            __('Recent Posts With Thumbnails', 'zo-mercury'), // Name
            array('description' => __('List of your site&#8217;s most recent posts, with clickable title and thumbnails.', 'zo-mercury'),) // Args
        );
		$this->plugin_version  = '2.3.1';
		$this->number_posts  = 5;
		$this->default_thumb_width  = 70;
		$this->default_thumb_height = 70;
 ...
 * @since 1.0
 */
function zo_mercury_register_recent_posts_widget_with_thumbnails () {
	register_widget('Zo_Mercury_Recent_Posts_Widget_With_Thumbnails');
}
add_action('widgets_init', 'zo_mercury_register_recent_posts_widget_with_thumbnails');