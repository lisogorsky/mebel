            ...
            <div class="zo-carousel-item">
                ...
                ?>
                    <div class="zo-product-overlay">
                        ...
                        <a data-rel="prettyPhoto" class="prettyPhoto product-zoom" href="<?php echo esc_url($img_full); ?>" ><span><?php _e('View', 'zo-mercury'); ?></span></a>
                        <?php
                        /**
                        ...
                        ?>
                        <a href="<?php the_permalink(); ?>" class="product-view"><span><?php _e('Links', 'zo-mercury'); ?></span></a>
